...
where $n$ is the sample size and $B$ is the beta function. The cumulative distribution function is then
    \begin{align*}
...
## References
  <p style="margin-left: .5in; text-indent: -.5in;">Turner, B. O., Paul, E. J., Miller, M. B., & Barbey, A. K. (2018). Small sample sizes reduce the replicability of task-based fMRI studies. Communications biology, 1(1), 62.</p>